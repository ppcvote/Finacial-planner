  ...
  content: \`
    <article class="prose prose-invert max-w-none">
      ...
      <div class="bg-purple-900/30 border border-purple-500/30 rounded-2xl p-6 my-8">
        ...
        <p class="text-slate-300 mb-0">
          「林先生，您目前房貸利率 2.4%，我們現在轉貸利率可以做到 2.0%。
          以您 800 萬的貸款餘額來說，每年可以省下 3.2 萬利息。<br/><br/>
          轉貸成本大約 2.5 萬，所以大概 10 個月就回本了。
          您房貸還剩 18 年對嗎？這樣算下來，總共可以省將近 55 萬。<br/><br/>
          不過在轉貸之前，我建議您可以先問問原銀行能不能降息，
          如果他們願意配合，連轉貸成本都省了。要不要我先幫您試算一下？」
        </p>
      </div>
