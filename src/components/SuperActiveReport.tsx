  ...
  return (
    ...
    <div className="font-sans text-slate-800 space-y-5 print:space-y-4 relative text-sm print:text-xs">
      ...
      <div className="relative z-10 bg-slate-50 rounded-2xl p-4 border border-slate-200 print-break-inside print:p-4">
          ...
          <div className="relative pt-6 pb-2 px-2 print:pt-5">
              {/* 進度條背景 */}
              ...
              >
                  <div className="bg-slate-700 text-white text-[10px] px-1.5 py-0.5 rounded mb-0.5 whitespace-nowrap font-bold shadow-sm">
                      {activeYears} 年
                  </div>
                  <div className="w-px h-7 bg-slate-700/50"></div>
              </div>

              {/* [Fix] 標籤指針 - 修正定位邏輯，移除錯誤的 -50 */}
              <div 
                className="absolute top-8 transform -translate-x-1/2 w-full text-center print:top-7"
      ...
      <div className="grid grid-cols-2 gap-4 print:gap-4 print-break-inside">
          ...
          <div className="bg-white rounded-xl border border-violet-200 p-0 shadow-sm relative overflow-hidden print:border-slate-300">
              ...
              {/* 支票內容 */}
              <div className="p-4 space-y-3 relative print:p-3 print:space-y-2">
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-4 shadow-sm relative flex items-center justify-between print:p-3">
              <div className="w-[55%] z-10">
                  <h4 className="font-bold text-slate-700 mb-2 text-xs print:text-[10px]">財富組成分析</h4>
                  <div className="space-y-2">
                      <div className="flex items-start gap-2">
                          <div className="w-2 h-2 rounded-full bg-violet-400 mt-1"></div>
                          <div>
                              <p className="text-[10px] text-slate-500">本金 (勞力)</p>
                      ...
                      <div className="flex items-start gap-2">
                          ...
                          <div>
                              <p className="text-[10px] text-slate-500">複利 (獲利)</p>
              ...
              <div className="w-[45%] h-[120px] relative print:h-[100px]">
      ...
      <div className="relative z-10 print-break-inside">
          <h2 className="text-lg font-bold text-slate-700 mb-3 flex items-center gap-2 print:text-base print:mb-2">
              <Rocket size={18} className="text-violet-600 print:w-4 print:h-4"/>
              執行藍圖 (火箭升空計畫)
          </h2>
          <div className="grid grid-cols-3 gap-3 print:gap-3">
              {[
                  ...
                  <div key={i} className={`rounded-xl border p-3 text-center ${p.color} print:p-2 flex flex-col justify-between h-full`}>
                      <div>
                          <p className="text-[10px] opacity-60 mb-0.5 font-bold uppercase">{p.sub}</p>
      ...
      <div className="relative z-10 space-y-2 print-break-inside">
          ...
          {/* [調整]: 高度 240px - 視覺平衡點 */}
          <div className="h-[280px] w-full border border-slate-100 rounded-xl p-4 bg-white shadow-sm print:h-[240px] print:p-3">
              <ResponsiveContainer width="100%" height="100%">
