  ...
  return (
    ...
    <div className="font-sans text-slate-800 space-y-6 print:space-y-5 relative text-sm print:text-xs">
      ...
      <div className="relative z-10 bg-slate-50 rounded-2xl p-5 border border-slate-200 print-break-inside print:p-5">
          ...
          <div className="relative pt-6 pb-2 print:pt-6">
              {/* 進度條背景 (加高) */}
              ...
              {/* [替代方案]: 靜態置中顯示，不再依賴脆弱的 left% 定位 */}
              <div className="mt-4 flex justify-center items-center">
                  <div className="bg-white border border-fuchsia-200 rounded-full px-4 py-1.5 shadow-sm inline-flex items-center gap-2">
                      <Star size={14} className="text-fuchsia-500" fill="currentColor"/>
                      <span className="text-fuchsia-600 font-bold text-sm print:text-xs">
                          恭喜！您成功贖回了 <span className="text-lg mx-1">{totalYears - activeYears}</span> 年的人生使用權
                      </span>
                  </div>
              </div>
          </div>
      ...
      {/* 5. 資產趨勢圖 (Active vs Passive) - 高度調整至 250px (填補空間) */}
      <div className="relative z-10 space-y-3 print-break-inside">
          ...
          {/* [調整]: 高度 250px */}
          <div className="h-[300px] w-full border border-slate-100 rounded-xl p-4 bg-white shadow-sm print:h-[250px] print:p-4">
              <ResponsiveContainer width="100%" height="100%">
