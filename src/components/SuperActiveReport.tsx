...
const SuperActiveReport = ({ data }: { data: any }) => {
  ...
  return (
    ...
    <div className="font-sans text-slate-800 space-y-5 print:space-y-3 relative text-sm print:text-xs">
      ...
      {/* 1. Header (高度微縮) */}
      <div className="relative z-10 flex items-center justify-between border-b-2 border-fuchsia-100 pb-3 print:pb-2 print-break-inside bg-white/50 backdrop-blur-sm">
      ...
      <div className="relative z-10 bg-slate-50 rounded-xl p-3 border border-slate-200 print-break-inside print:p-2">
          ...
          {/* [FIX]: 
             1. 容器高度固定 h-12，方便絕對定位 
             2. 移除任何 margin/padding 干擾 
          */}
          <div className="relative w-full h-12 mt-2">
              ...
              {/* 分隔線與上方標籤 (絕對定位) */}
              {/* [FIX]: height: 100% 確保線條貫穿，top-0 left-[X%] 確保水平位置準確 */}
              <div 
              ...
              >
                  {/* 上方標籤 */}
                  <div className="bg-slate-700 text-white text-[9px] px-1.5 py-0.5 rounded mb-1 whitespace-nowrap font-bold shadow-sm">
                      {activeYears} 年
                  </div>
                  {/* 垂直貫穿線 (覆蓋在 Bar 上) */}
                  <div className="w-0.5 h-6 bg-white/80 outline outline-1 outline-slate-400/50"></div>
                  {/* 下方佔位 (保持平衡) */}
              ...
              >
                  <p className="text-fuchsia-600 font-bold text-[10px] flex items-center justify-center gap-1 whitespace-nowrap leading-none mb-[-4px]">
      ...
      <div className="grid grid-cols-2 gap-3 print:gap-3 print-break-inside">
          ...
          <div className="bg-white rounded-xl border border-violet-200 p-0 shadow-sm relative overflow-hidden print:border-slate-300">
              ...
              <div className="p-3 space-y-2 relative print:p-2 print:space-y-1">
                  ...
                  <div className="flex justify-between items-end">
                      ...
                      <span className="text-[9px] text-slate-400 mb-1">/ 月 (Monthly)</span>
                  </div>
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-3 shadow-sm relative flex items-center justify-between print:p-2">
              ...
              <div className="w-[45%] h-[100px] relative print:h-[80px]">
      ...
      {/* 5. 資產趨勢圖 (Active vs Passive) - 高度縮減至 180px */}
