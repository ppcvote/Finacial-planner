    ...
    <div className="flex flex-col items-center gap-8 p-8 bg-black min-h-screen text-white font-sans">
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center mt-4 mb-8">
          <div className="w-14 h-14 mb-3 bg-gradient-to-b from-amber-400 to-amber-700 rounded-full p-[1px] shadow-lg shadow-amber-900/20">
            <div className="w-full h-full bg-[#080808] rounded-full flex items-center justify-center">
              <img src="/logo.png" className="w-8 h-8" alt="UA Logo" />
            </div>
          </div>
          <div className="flex flex-col items-center">
            <span className="text-white font-black tracking-[0.6em] text-[12px] uppercase mb-1">Ultra Advisor</span>
        ...
        <div className="relative z-10 px-2">
          ...
          <p className="text-amber-200/40 text-[11px] font-bold tracking-wider leading-relaxed">
            {dailyData?.subtitle || " "}
          </p>
        </div>
        ...
        {dailyData?.visualChart && (
          <div 
            className="relative z-10 my-6 flex justify-center bg-white/[0.02] p-4 rounded-2xl border border-white/5"
        ...
        <div className="relative z-10 mt-auto pt-6 border-t border-white/10 flex justify-between items-end px-2">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl flex items-center justify-center border border-white/10">
              <img src="/logo.png" className="w-5 h-5 opacity-80" alt="logo" />
            </div>
            <div>
              <p className="text-[13px] font-black text-white tracking-tight mb-0.5">{advisorName}</p>
              <p className="text-[7px] text-gray-500 tracking-[0.2em] uppercase font-bold">Wealth Strategy Elite</p>
            </div>
          </div>
          <div className="text-right pb-1">
            <p className="text-[9px] text-amber-600/80 font-black tracking-widest uppercase">Insight System</p>
          </div>
        </div>
      </div>
    </div>
