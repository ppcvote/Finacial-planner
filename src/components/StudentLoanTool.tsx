          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 h-[500px] print-break-inside relative">
            ...
            <ResponsiveContainer width="100%" height="90%">
              <ComposedChart data={dataArr} margin={{ top: 20, right: 30, left: 0, bottom: 20 }}>
                ...
                {/* 寬限期 */}
                {gracePeriod > 0 && graceStartLabel && graceEndLabel && (
                  <ReferenceArea 
                    x1={graceStartLabel}
                    x2={graceEndLabel}
                ...
                {/* 只繳息期 */}
                {interestOnlyPeriod > 0 && interestStartLabel && interestEndLabel && (
                  <ReferenceArea 
                    x1={interestStartLabel}
                    x2={interestEndLabel}
